...
O código simula elementos básicos de um jogo RPG, incluindo inventário, personagem, habilidades e inimigos.
...
* Adição de novos itens com `push()`.
* Remoção de itens com `pop()`.
* Inserção de itens no início do array com `unshift()`.
...
* Acesso a propriedades utilizando notação de colchetes.
...
* Acesso aos dados recuperados após a conversão.
...
```bash
cd Atividade_Pratica-Arrays-Objetos-JSON
```
